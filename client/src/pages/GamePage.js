...
export function GamePage({ onReturnToMenu }) {
    ...
    return (_jsxs("div", { className: "game-shell", children: [_jsx("div", { className: "game-toolbar", children: _jsx("button", { className: "secondary-button", type: "button", onClick: onReturnToMenu, children: "RETURN TO MENU" }) }), _jsx(GameCanvas, { initialSceneKey: "GameScene" }), _jsx(DialoguePanel, {}), _jsx(QuestPanel, {}), _jsx(DeathOverlay, {}), levelUpMessage ? _jsx("div", { className: "level-up-toast", children: levelUpMessage }) : null, notification ? _jsx("div", { className: "notification-toast", children: notification.message }) : null] }));
}
