...
export class Slime extends Phaser.Physics.Arcade.Sprite {
  ...
  public state: 'idle' | 'patrol' | 'chase' | 'attack' | 'hurt' | 'dead' = 'patrol';

  public patrolCenterX: number;
  ...
  private readonly onDefeated: (slime: Slime) => void;

  public constructor(scene: Phaser.Scene, x: number, y: number, config: Partial<SlimeConfig> = {}) {
  ...
  public takeDamage(amount: number, _source?: unknown): boolean {
    if (this.isDead) {
      return false;
    }
