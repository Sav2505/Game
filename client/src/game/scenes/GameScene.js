...
export class GameScene extends Phaser.Scene {
    ...
    lastNetworkSyncAt = 0;
    lastPublishedPlayerSnapshotKey = '';
    savedSnapshot;
    runtimeBridge = {
    ...
    async dropInventoryItem(itemId) {
    ...
    syncRemotePlayers(players) {
        ...
        const nextPlayers = new Map(players
    ...
    publishLocalPlayerState(force = false) {
