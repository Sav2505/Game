...
export class CharacterShowcaseScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.characterRenderer = new CharacterRenderer(this, characterStore.getState().character, width * 0.52, height * 0.78);
    ...
    update(time) {
        ...
        this.characterRenderer.setPosition(this.scale.width * 0.52, this.scale.height * 0.78 + bob);
