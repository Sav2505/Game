function drawPlayer(graphics, hurt = false) {
    graphics.clear();
...
function drawSlime(graphics, hurt = false) {
    graphics.clear();
...
function drawGroundTile(graphics) {
    graphics.clear();
    graphics.fillStyle(0x2f7d49, 1);
...
function drawPlatformTile(graphics) {
    graphics.clear();
...
function drawCloudLayer(graphics) {
    graphics.clear();
    graphics.fillStyle(0xffffff, 0.65);
...
function drawMountainLayer(graphics) {
    graphics.clear();
...
function drawTreeLayer(graphics) {
    graphics.clear();
...
function drawParticle(graphics) {
    graphics.clear();
